...
int main(){
  ...
  // 9,13,24,52,20,46 - Step 1st index with min element [1 to n-1 array]
  // 9,13,20,52,24,46 - Step 2nd index with min element [2 to n-1 array]
  // 9,13,20,24,52,46 - Step 3rd index with min element [3 to n-1 array]
